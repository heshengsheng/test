...
$css = ["zTreeStyle.css"];
$jss = ["jquery.ztree.core.min.js","jquery.ztree.excheck.min.js","ajaxfileupload.js","heatmap.js"];
        ...
        <div id="hms">
          <p>hhhhhhh</p>
             <div id="selectDataset">
                ...
                <select>
                  <option selected>Data Set1</option>
                  <option>Data Set2</option>
                  <option>Data Set3</option>
                </select>      
                <h4>Select Genomic Profiles:</h4>            
            ...
            <p>according to <a href='/documentation#heatMap'>this format</a></p>
